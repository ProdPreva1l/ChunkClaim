...
public enum Menus {
    ...
    public String toString() {
        String str = ChunkClaim.i().getMenusFile().getString(path);
        if (str.equals(path)) {
    ...
    public List<String> toStringList() {
        List<String> str = ChunkClaim.i().getMenusFile().getStringList(path);
    ...
    public static void loadDefault() {
        BasicConfig configFile = ChunkClaim.i().getMenusFile();
