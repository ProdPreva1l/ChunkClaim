package info.preva1l.chunkclaim.utils.commands;


import info.preva1l.chunkclaim.ChunkClaim;
import info.preva1l.chunkclaim.config.Lang;
import info.preva1l.chunkclaim.utils.TaskManager;
    ...
    public class CommandExecutor extends BukkitCommand {
        ...
        public boolean execute(CommandSender sender, String label, String[] args) {
            ...
            if (!this.getPermission().isEmpty() && !sender.hasPermission(this.getPermission())) {
                sender.sendMessage(Lang.ERROR_NO_PERMISSION.toString());
                return false;
            }
